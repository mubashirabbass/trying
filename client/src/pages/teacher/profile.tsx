  ...
  return (
    <DashboardLayout>
      <div className="max-w-3xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-black text-gray-900 tracking-tight">Faculty Profile</h1>
          <p className="text-gray-500 mt-1">Manage your instructor information and account security.</p>
        </div>
          ...
          <CardContent className="px-8 pb-8">
            <div className="flex flex-col md:flex-row items-start md:items-end gap-6 -mt-12">
              <div className="relative">
                <div className="h-24 w-24 rounded-[20px] bg-white shadow-xl ring-4 ring-white flex items-center justify-center text-indigo-600 text-4xl font-black">
              ...
              <div className="flex-1 pb-1">
                ...
                <div className="flex items-center gap-2 mt-1 flex-wrap">
                  <Badge className="bg-indigo-50 text-indigo-700 border-indigo-100 font-bold gap-1">
                    <GraduationCap className="h-3 w-3" /> Faculty
                  </Badge>
                  <Badge className="bg-emerald-50 text-emerald-700 border-emerald-100 font-bold gap-1">
                    <BookOpen className="h-3 w-3" /> Active Instructor
                  </Badge>
                </div>
              </div>
            </div>
        ...
        <Tabs defaultValue="profile" className="space-y-6">
          <TabsList className="bg-white p-1 rounded-2xl shadow-sm ring-1 ring-gray-100 w-full justify-start h-14">
            <TabsTrigger value="profile" className="rounded-xl h-12 px-6 font-bold data-[state=active]:bg-primary data-[state=active]:text-white">
              <Edit3 className="h-4 w-4 mr-2" /> Personal Info
            </TabsTrigger>
          ...
          <TabsContent value="profile">
            <Card className="border-none shadow-sm ring-1 ring-gray-100 rounded-[24px]">
              <CardHeader className="px-8 pt-8 pb-0">
                <CardTitle className="text-lg font-black text-gray-900">Edit Information</CardTitle>
              </CardHeader>
              <CardContent className="p-8 space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input className="pl-10 h-11 rounded-xl border-gray-200 bg-gray-50 text-gray-500"
